...
// Modal de detalhe do deal. Vivia dentro de pipeline/page.tsx; foi extraido pra que a aba
// Lista abra EXATAMENTE o mesmo modal, em vez de nascer uma segunda versao pra manter.
...
export function LossReasonDialog({ busy, company, error, onCancel, onConfirm, title }: {
  busy: boolean;
  company: string;
  error?: string | null;
  onCancel: () => void;
...
export function DealDetailOverlay({ deal, onClose, onDelete, onStageChange }: DealDetailOverlayProps) {
